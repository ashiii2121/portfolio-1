...
const ProjectImageGallery = ({ images, title, onImageClick, palette = [] }) => {
  ...
  const accentColor = palette[2] || '#A68167';
    ...
    <>
      ...
      >
        ...
        >
          <OptimizedImage
            src={displayImages[0]}
            alt={`${title} project main view - Interior design showcase`}
        ...
        <div className="thumbnail-grid">
          {displayImages.slice(1, 4).map((image, index) => (
            ...
            >
              <OptimizedImage
                src={image}
                alt={`${title} project view ${index + 2} - Interior design detail`}
